        ...
        if (window.hasOwnProperty('webkitSpeechRecognition')) {
            ...
            recognition.start();
               ...
               recognition.onresult = function(e) {
                ...
                let speech = e.results[0][0].transcript;
                speech = speech.trim().replace(/\r?\n/g, ' ');
                console.log(speech);
                speech=speech.toLowerCase();
                console.log(speech);

                if(speech.match("start")||speech.match("okay mag")||speech.match("okay mak")||speech.match("ok mac")||speech.match("ok mak")||speech.match("ok mag"))
                {
