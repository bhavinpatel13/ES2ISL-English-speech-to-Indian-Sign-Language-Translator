...
<meta name="author" content="Manthan Khanvilkar - Lakehead University" >
...
<script type="application/json" src="js/sigmlFiles.json"></script>
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
     ...
     <a class="navbar-brand" href="index.php" style="padding:0;padding-left:10px;"><h1 style="padding:0; margin:0;"><img src="images/seeyoulater.gif" style="height:75px; margin-top:-10px; margin-left:-70px;" position="absolute"></h1></a>
         <img src="images/ASL.jpg" class = "brand-logo" style="height: 50px;position:static;margin-right margin-right: auto;margin-top: 5px;  position="absolute" display: block">
    </div>
...
<div class="navb" style="margin-left:150px;">
    <a class="active" href=""><i class="glyphicon glyphicon-expand"></i> Interactive</a>
    <a href="" onclick ="startDictation2(); return false;"><i class="fa fa-spinner"></i> Seemless</a>
...
<script>
    ...
    $(".navb a").click(function() {
        ...
        $(this).addClass('active');
            ...
            <div id="menu1">
            <br>
                    <img src="images/speechloader.gif" id="speech_loader"  style="width: 300px; height:300px; margin-top:170px;margin-left:130px;">
                    <p class="text-center" id="listening" style="margin-top: 395px;margin-left:230px; position:fixed; font-size: 20px;">Listening...</p>



            <img src="images/microphone.jpg" id= "playeng" style="width: 60px; height:60px; margin-left:240px;margin-top:310px;cursor:pointer;">
             <p class="text-center" id="clicktospeak" style="margin-top: 370px;margin-left:200px; position:fixed; font-size: 20px;">Click to Speak</p>

                <div id="speech" style="margin-top:40px; border-top:3px solid black;">
                <br><strong><span id="speech_text" style="font-size: 18px;">Speech</span></strong></br>
                <div><span id="speech_"></span></div>
            </div>

            <div style="margin-top:60px; border-top:3px solid black;">
                <br><strong><span id="isl_text" style="font-size: 18px;">Hindi Sign Language</span></strong></br>
                <div id="isl"></div>
            </div>
...
$("#hinditext").on('keypress', function(e) {
    ...
    if(code==32){ // space has been pressed
        ...
        converttohindi(hinditext);        
	     ...
	     hinditext = $("#transliterateTextarea").val();
        converttohindi(hinditext); 	
	}
